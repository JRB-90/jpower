...
elseif (PLATFORM STREQUAL "nrf52840_xxAA")
    ...
    #set(BOARD "SEEED_XIAO_SENSE" CACHE STRING "Board to build examples for.")
    #set_property(CACHE BOARD PROPERTY STRINGS "SEEED_XIAO_SENSE")
    set(BOARD "JPOWER_V1" CACHE STRING "Board to build examples for.")
    set_property(CACHE BOARD PROPERTY STRINGS "JPOWER_V1")
...
if (NOT EXISTS "${CMAKE_SOURCE_DIR}/board/${BOARD}.cmake")
    get_property(SUPPORTED CACHE BOARD PROPERTY STRINGS)
