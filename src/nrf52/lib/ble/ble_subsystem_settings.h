...
#define MIN_CONN_INTERVAL               MSEC_TO_UNITS(12, UNIT_1_25_MS)         // Minimum acceptable connection interval (15ms)
#define MAX_CONN_INTERVAL               MSEC_TO_UNITS(24, UNIT_1_25_MS)         // Maximum acceptable connection interval (30ms)
